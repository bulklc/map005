...
function WaterATMs1rule0_eval_expression(context) {
    // Entity = 'Dr Water' AND "Tested?" = 'yes'
...
function WaterATMs1rule1_eval_expression(context) {
    // Entity = 'Dr Water' AND "Tested?" = 'not yet'
...
function WaterATMs1rule2_eval_expression(context) {
    // (Entity = 'other' OR Entity = 'Selco') AND "Tested?" = 'yes'
...
function WaterATMs1rule3_eval_expression(context) {
    // (Entity = 'other' OR Entity = 'Selco') AND "Tested?" = 'not yet'
